# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 12:06:40 2023
...
parser.add_argument('--save-dir', type=str, default='GradientBoostingRegressor', help="Save directory")
...
print("Start Cross validation feature selection with Gradient Boosting Regressor")
tic     = time.time()
...
# save the model
joblib.dump(model, args.save_dir + '/GradientBoostingRegressor_model.pkl')
