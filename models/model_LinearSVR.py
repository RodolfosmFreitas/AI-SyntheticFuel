# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 11:10:25 2023
...
parser.add_argument('--save-dir', type=str, default='LinearSVR', help="Save directory")
...
# print("Start Cross validation feature selection with SVR")
# tic     = time.time()
# model   = LinearSVR(epsilon=0.2,                    # epsilon parameter   
#                     dual='auto',
...
# sorted_idx_train = feat_imp_train.importances_mean.argsort()

# plt.figure(figsize=(8,6), dpi=150)
# plt.boxplot(feat_imp_train.importances[sorted_idx_train].T,
#             labels=np.array(rfe.get_feature_names_out())[sorted_idx_train],
#             patch_artist=True,
#             vert=False,
...
# # save the model
# joblib.dump(model, args.save_dir + '/LinearSVR_model.pkl')
...
# X_train = X_train * X_std + X_
# X_test  = X_test * X_std + X_
