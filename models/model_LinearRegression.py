# -*- coding: utf-8 -*-
"""
Created on Wed Sep 20 16:06:45 2023
...
parser.add_argument('--save-dir', type=str, default='LASSORegressor', help="Save directory")
...
print("Start Cross validation feature selection with Linear Regresssion")
tic     = time.time()
...
# save the model
joblib.dump(model, args.save_dir + '/LinearRegressor_model.pkl')
...
def scatter_plot(var1,var2, var3, var4, r2_train, r2_test):
    ...
    plt.xticks(fontsize=18)
    plt.yticks(fontsize=18)
    plt.xlabel(r'$CN_{Pred}$',fontsize=18)
